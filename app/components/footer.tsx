...
const Footer = () => {
  return (
    ...
    <div className='text-white bg-black'>
        <div className='flex justify-between m-14 pt-24'>
            <div>
                <div className='font-medium text-2xl border-b-2 border-gray-900 border-spacing-4 relative'>About The Store
                <span className='absolute left-0 bottom-[-1px] h-[1px] w-[60px] bg-red-500'></span>
                </div>
                <div className='w-72 pt-10'>The Store at Shoponix is an original voice, and one of the leading shopping destinations in New York City, offering a curated selection of well-executed contemporary artist-made objects and jewelry.</div>
            </div>
            ...
            <div>
                <div className='font-medium text-2xl border-b-2 border-gray-900 relative'>Support Links
                <span className='absolute left-0 bottom-[-1px] h-[1px] w-[60px] bg-red-500'></span>
                </div>
                <div className='pt-10 pb-3 cursor-pointer group'>
                    <Link href={''}>
            ...
            <div>
                <div className='font-medium text-2xl border-b-2 border-gray-900 relative'>Contact Info
                <span className='absolute left-0 bottom-[-1px] h-[1px] w-[60px] bg-red-500'></span>
                </div>
