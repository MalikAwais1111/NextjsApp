...
const Cart = () => {
  ...
  return (
    <div className='min-h-screen flex pt-20 pb-10 justify-center items-center bg-gray-300'>
      <div className="bg-white p-4 rounded-lg shadow-lg w-full max-w-3xl flex flex-col max-h-screen">
        ...
        <div className='flex flex-col sm:flex-row justify-between items-center rounded-md align-middle mt-5 p-3 border border-solid border-slate-300 font-medium text-lg'>
          <div>
